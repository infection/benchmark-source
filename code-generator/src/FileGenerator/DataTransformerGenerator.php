...
final readonly class DataTransformerGenerator implements FileGenerator
{
    ...
    final class DataTransformer__ID__
    {
        /**
         * @template T
         * @param array<T> $array
    ...
    public function generate(string $id): GeneratedFile
    {
        return new GeneratedFile(
            sprintf(
                'src/AutoGenerated/DataTransformer/DataTransformer%s.php',
                $id,
            ),
            str_replace(
                '__ID__',
