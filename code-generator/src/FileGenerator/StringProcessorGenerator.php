...
final readonly class StringProcessorGenerator implements FileGenerator
{
    ...
    final class StringProcessor__ID__
    {
    ...
    public function generate(string $id): GeneratedFile
    {
        return new GeneratedFile(
            sprintf(
                'src/AutoGenerated/StringProcessor/StringProcessor%s.php',
                $id,
            ),
            str_replace(
                '__ID__',
