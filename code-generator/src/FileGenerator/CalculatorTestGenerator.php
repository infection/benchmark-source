...
final readonly class CalculatorTestGenerator implements FileGenerator
{
    ...
    use Infection\BenchmarkSource\AutoGenerated\Calculator\Calculator__ID__;
    use InvalidArgumentException;
    use PHPUnit\Framework\Attributes\CoversClass;
    use PHPUnit\Framework\Attributes\DataProvider;
    use PHPUnit\Framework\TestCase;

    #[CoversClass(Calculator__ID__::class)]
    final class Calculator__ID__Test extends TestCase
    {
        private Calculator__ID__ $calculator;

        protected function setUp(): void
        {
            $this->calculator = new Calculator__ID__();
        }
    ...
    public function generate(string $id): GeneratedFile
    {
        return new GeneratedFile(
            sprintf(
                'tests/AutoGenerated/Calculator/Calculator%sTest.php',
                $id,
            ),
            str_replace(
                '__ID__',
