...
final readonly class DataTransformerTestGenerator implements FileGenerator
{
    ...
    use Infection\BenchmarkSource\AutoGenerated\DataTransformer\DataTransformer__ID__;
    use InvalidArgumentException;
    use PHPUnit\Framework\Attributes\CoversClass;
    use PHPUnit\Framework\Attributes\DataProvider;
    use PHPUnit\Framework\TestCase;

    #[CoversClass(DataTransformer__ID__::class)]
    final class DataTransformer__ID__Test extends TestCase
    {
        private DataTransformer__ID__ $transformer;

        protected function setUp(): void
        {
            $this->transformer = new DataTransformer__ID__();
        }
    ...
    public function generate(string $id): GeneratedFile
    {
        return new GeneratedFile(
            sprintf(
                'tests/AutoGenerated/DataTransformer/DataTransformer%sTest.php',
                $id,
            ),
            str_replace(
                '__ID__',
