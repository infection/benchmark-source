...
final readonly class StringProcessorTestGenerator implements FileGenerator
{
    ...
    use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor__ID__;
    use InvalidArgumentException;
    use PHPUnit\Framework\Attributes\CoversClass;
    use PHPUnit\Framework\Attributes\DataProvider;
    use PHPUnit\Framework\TestCase;

    #[CoversClass(StringProcessor__ID__::class)]
    final class StringProcessor__ID__Test extends TestCase
    {
        public function test_can_be_instantiated(): void
        {
            $processor = new StringProcessor__ID__('Hello World');
        ...
        {
            $processor = new StringProcessor__ID__('Hello World', false);
        ...
        {
            $processor = new StringProcessor__ID__('Hello');
        ...
        {
            $processor = new StringProcessor__ID__($haystack, $caseSensitive);
        ...
        {
            $processor = new StringProcessor__ID__($value, $caseSensitive);
        ...
        {
            $processor = new StringProcessor__ID__($value);
    ...
    public function generate(string $id): GeneratedFile
    {
        return new GeneratedFile(
            sprintf(
                'tests/AutoGenerated/StringProcessor/StringProcessor%sTest.php',
                $id,
            ),
            str_replace(
                '__ID__',
