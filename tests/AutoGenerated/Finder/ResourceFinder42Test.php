...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder42;
...
#[CoversClass(ResourceFinder42::class)]
final class ResourceFinder42Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder42(10);
    ...
    {
        $instance = new ResourceFinder42(10);
    ...
    {
        $finder = new ResourceFinder42($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder42(value=%s)', $i),
            ];
        }
    }
}
