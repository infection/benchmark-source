...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder35;
...
#[CoversClass(ResourceFinder35::class)]
final class ResourceFinder35Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder35(10);
    ...
    {
        $instance = new ResourceFinder35(10);
    ...
    {
        $finder = new ResourceFinder35($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder35(value=%s)', $i),
            ];
        }
    }
}
