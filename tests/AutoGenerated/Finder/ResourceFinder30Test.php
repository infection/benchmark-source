...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder30;
...
#[CoversClass(ResourceFinder30::class)]
final class ResourceFinder30Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder30(10);
    ...
    {
        $instance = new ResourceFinder30(10);
    ...
    {
        $finder = new ResourceFinder30($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder30(value=%s)', $i),
            ];
        }
    }
}
