...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder05;
...
#[CoversClass(ResourceFinder05::class)]
final class ResourceFinder05Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder05(10);
    ...
    {
        $instance = new ResourceFinder05(10);
    ...
    {
        $finder = new ResourceFinder05($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder05(value=%s)', $i),
            ];
        }
    }
}
