...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder02;
...
#[CoversClass(ResourceFinder02::class)]
final class ResourceFinder02Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder02(10);
    ...
    {
        $instance = new ResourceFinder02(10);
    ...
    {
        $finder = new ResourceFinder02($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder02(value=%s)', $i),
            ];
        }
    }
}
