...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder27;
...
#[CoversClass(ResourceFinder27::class)]
final class ResourceFinder27Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder27(10);
    ...
    {
        $instance = new ResourceFinder27(10);
    ...
    {
        $finder = new ResourceFinder27($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder27(value=%s)', $i),
            ];
        }
    }
}
