...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder43;
...
#[CoversClass(ResourceFinder43::class)]
final class ResourceFinder43Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder43(10);
    ...
    {
        $instance = new ResourceFinder43(10);
    ...
    {
        $finder = new ResourceFinder43($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder43(value=%s)', $i),
            ];
        }
    }
}
