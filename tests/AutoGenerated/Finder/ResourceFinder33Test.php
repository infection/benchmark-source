...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder33;
...
#[CoversClass(ResourceFinder33::class)]
final class ResourceFinder33Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder33(10);
    ...
    {
        $instance = new ResourceFinder33(10);
    ...
    {
        $finder = new ResourceFinder33($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder33(value=%s)', $i),
            ];
        }
    }
}
