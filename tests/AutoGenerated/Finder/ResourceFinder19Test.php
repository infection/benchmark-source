...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder19;
...
#[CoversClass(ResourceFinder19::class)]
final class ResourceFinder19Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder19(10);
    ...
    {
        $instance = new ResourceFinder19(10);
    ...
    {
        $finder = new ResourceFinder19($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder19(value=%s)', $i),
            ];
        }
    }
}
