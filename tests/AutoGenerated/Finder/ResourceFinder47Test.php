...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder47;
...
#[CoversClass(ResourceFinder47::class)]
final class ResourceFinder47Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder47(10);
    ...
    {
        $instance = new ResourceFinder47(10);
    ...
    {
        $finder = new ResourceFinder47($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder47(value=%s)', $i),
            ];
        }
    }
}
