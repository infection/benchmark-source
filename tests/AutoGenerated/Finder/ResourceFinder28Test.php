...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder28;
...
#[CoversClass(ResourceFinder28::class)]
final class ResourceFinder28Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder28(10);
    ...
    {
        $instance = new ResourceFinder28(10);
    ...
    {
        $finder = new ResourceFinder28($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder28(value=%s)', $i),
            ];
        }
    }
}
