...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder15;
...
#[CoversClass(ResourceFinder15::class)]
final class ResourceFinder15Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder15(10);
    ...
    {
        $instance = new ResourceFinder15(10);
    ...
    {
        $finder = new ResourceFinder15($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder15(value=%s)', $i),
            ];
        }
    }
}
