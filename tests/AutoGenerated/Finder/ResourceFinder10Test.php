...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder10;
...
#[CoversClass(ResourceFinder10::class)]
final class ResourceFinder10Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder10(10);
    ...
    {
        $instance = new ResourceFinder10(10);
    ...
    {
        $finder = new ResourceFinder10($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder10(value=%s)', $i),
            ];
        }
    }
}
