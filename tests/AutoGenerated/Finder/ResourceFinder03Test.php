...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder03;
...
#[CoversClass(ResourceFinder03::class)]
final class ResourceFinder03Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder03(10);
    ...
    {
        $instance = new ResourceFinder03(10);
    ...
    {
        $finder = new ResourceFinder03($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder03(value=%s)', $i),
            ];
        }
    }
}
