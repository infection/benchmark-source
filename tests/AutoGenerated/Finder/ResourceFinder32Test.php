...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder32;
...
#[CoversClass(ResourceFinder32::class)]
final class ResourceFinder32Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder32(10);
    ...
    {
        $instance = new ResourceFinder32(10);
    ...
    {
        $finder = new ResourceFinder32($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder32(value=%s)', $i),
            ];
        }
    }
}
