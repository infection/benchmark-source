...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder40;
...
#[CoversClass(ResourceFinder40::class)]
final class ResourceFinder40Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder40(10);
    ...
    {
        $instance = new ResourceFinder40(10);
    ...
    {
        $finder = new ResourceFinder40($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder40(value=%s)', $i),
            ];
        }
    }
}
