...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder20;
...
#[CoversClass(ResourceFinder20::class)]
final class ResourceFinder20Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder20(10);
    ...
    {
        $instance = new ResourceFinder20(10);
    ...
    {
        $finder = new ResourceFinder20($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder20(value=%s)', $i),
            ];
        }
    }
}
