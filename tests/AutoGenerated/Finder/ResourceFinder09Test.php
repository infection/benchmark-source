...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder09;
...
#[CoversClass(ResourceFinder09::class)]
final class ResourceFinder09Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder09(10);
    ...
    {
        $instance = new ResourceFinder09(10);
    ...
    {
        $finder = new ResourceFinder09($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder09(value=%s)', $i),
            ];
        }
    }
}
