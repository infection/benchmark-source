...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder23;
...
#[CoversClass(ResourceFinder23::class)]
final class ResourceFinder23Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder23(10);
    ...
    {
        $instance = new ResourceFinder23(10);
    ...
    {
        $finder = new ResourceFinder23($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder23(value=%s)', $i),
            ];
        }
    }
}
