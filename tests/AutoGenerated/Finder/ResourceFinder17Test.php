...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder17;
...
#[CoversClass(ResourceFinder17::class)]
final class ResourceFinder17Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder17(10);
    ...
    {
        $instance = new ResourceFinder17(10);
    ...
    {
        $finder = new ResourceFinder17($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder17(value=%s)', $i),
            ];
        }
    }
}
