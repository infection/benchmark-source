...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder21;
...
#[CoversClass(ResourceFinder21::class)]
final class ResourceFinder21Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder21(10);
    ...
    {
        $instance = new ResourceFinder21(10);
    ...
    {
        $finder = new ResourceFinder21($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder21(value=%s)', $i),
            ];
        }
    }
}
