...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder07;
...
#[CoversClass(ResourceFinder07::class)]
final class ResourceFinder07Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder07(10);
    ...
    {
        $instance = new ResourceFinder07(10);
    ...
    {
        $finder = new ResourceFinder07($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder07(value=%s)', $i),
            ];
        }
    }
}
