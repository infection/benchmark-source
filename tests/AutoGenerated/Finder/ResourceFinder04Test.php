...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder04;
...
#[CoversClass(ResourceFinder04::class)]
final class ResourceFinder04Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder04(10);
    ...
    {
        $instance = new ResourceFinder04(10);
    ...
    {
        $finder = new ResourceFinder04($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder04(value=%s)', $i),
            ];
        }
    }
}
