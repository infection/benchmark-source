...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder45;
...
#[CoversClass(ResourceFinder45::class)]
final class ResourceFinder45Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder45(10);
    ...
    {
        $instance = new ResourceFinder45(10);
    ...
    {
        $finder = new ResourceFinder45($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder45(value=%s)', $i),
            ];
        }
    }
}
