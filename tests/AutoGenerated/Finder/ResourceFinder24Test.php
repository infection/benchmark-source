...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder24;
...
#[CoversClass(ResourceFinder24::class)]
final class ResourceFinder24Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder24(10);
    ...
    {
        $instance = new ResourceFinder24(10);
    ...
    {
        $finder = new ResourceFinder24($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder24(value=%s)', $i),
            ];
        }
    }
}
