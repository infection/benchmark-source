...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder49;
...
#[CoversClass(ResourceFinder49::class)]
final class ResourceFinder49Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder49(10);
    ...
    {
        $instance = new ResourceFinder49(10);
    ...
    {
        $finder = new ResourceFinder49($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder49(value=%s)', $i),
            ];
        }
    }
}
