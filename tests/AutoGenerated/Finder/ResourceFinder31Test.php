...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder31;
...
#[CoversClass(ResourceFinder31::class)]
final class ResourceFinder31Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder31(10);
    ...
    {
        $instance = new ResourceFinder31(10);
    ...
    {
        $finder = new ResourceFinder31($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder31(value=%s)', $i),
            ];
        }
    }
}
