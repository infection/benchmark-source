...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder18;
...
#[CoversClass(ResourceFinder18::class)]
final class ResourceFinder18Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder18(10);
    ...
    {
        $instance = new ResourceFinder18(10);
    ...
    {
        $finder = new ResourceFinder18($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder18(value=%s)', $i),
            ];
        }
    }
}
