...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder14;
...
#[CoversClass(ResourceFinder14::class)]
final class ResourceFinder14Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder14(10);
    ...
    {
        $instance = new ResourceFinder14(10);
    ...
    {
        $finder = new ResourceFinder14($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder14(value=%s)', $i),
            ];
        }
    }
}
