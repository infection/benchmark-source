...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder46;
...
#[CoversClass(ResourceFinder46::class)]
final class ResourceFinder46Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder46(10);
    ...
    {
        $instance = new ResourceFinder46(10);
    ...
    {
        $finder = new ResourceFinder46($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder46(value=%s)', $i),
            ];
        }
    }
}
