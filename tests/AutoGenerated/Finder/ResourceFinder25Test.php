...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder25;
...
#[CoversClass(ResourceFinder25::class)]
final class ResourceFinder25Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder25(10);
    ...
    {
        $instance = new ResourceFinder25(10);
    ...
    {
        $finder = new ResourceFinder25($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder25(value=%s)', $i),
            ];
        }
    }
}
