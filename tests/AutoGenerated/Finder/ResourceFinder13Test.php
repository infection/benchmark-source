...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder13;
...
#[CoversClass(ResourceFinder13::class)]
final class ResourceFinder13Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder13(10);
    ...
    {
        $instance = new ResourceFinder13(10);
    ...
    {
        $finder = new ResourceFinder13($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder13(value=%s)', $i),
            ];
        }
    }
}
