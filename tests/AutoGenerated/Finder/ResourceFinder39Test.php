...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder39;
...
#[CoversClass(ResourceFinder39::class)]
final class ResourceFinder39Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder39(10);
    ...
    {
        $instance = new ResourceFinder39(10);
    ...
    {
        $finder = new ResourceFinder39($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder39(value=%s)', $i),
            ];
        }
    }
}
