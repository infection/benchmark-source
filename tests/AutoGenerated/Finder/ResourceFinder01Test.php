...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder01;
...
#[CoversClass(ResourceFinder01::class)]
final class ResourceFinder01Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder01(10);
    ...
    {
        $instance = new ResourceFinder01(10);
    ...
    {
        $finder = new ResourceFinder01($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder01(value=%s)', $i),
            ];
        }
    }
}
