...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder37;
...
#[CoversClass(ResourceFinder37::class)]
final class ResourceFinder37Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder37(10);
    ...
    {
        $instance = new ResourceFinder37(10);
    ...
    {
        $finder = new ResourceFinder37($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder37(value=%s)', $i),
            ];
        }
    }
}
