...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder41;
...
#[CoversClass(ResourceFinder41::class)]
final class ResourceFinder41Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder41(10);
    ...
    {
        $instance = new ResourceFinder41(10);
    ...
    {
        $finder = new ResourceFinder41($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder41(value=%s)', $i),
            ];
        }
    }
}
