...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder44;
...
#[CoversClass(ResourceFinder44::class)]
final class ResourceFinder44Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder44(10);
    ...
    {
        $instance = new ResourceFinder44(10);
    ...
    {
        $finder = new ResourceFinder44($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder44(value=%s)', $i),
            ];
        }
    }
}
