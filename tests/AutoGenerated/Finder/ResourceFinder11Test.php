...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder11;
...
#[CoversClass(ResourceFinder11::class)]
final class ResourceFinder11Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder11(10);
    ...
    {
        $instance = new ResourceFinder11(10);
    ...
    {
        $finder = new ResourceFinder11($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder11(value=%s)', $i),
            ];
        }
    }
}
