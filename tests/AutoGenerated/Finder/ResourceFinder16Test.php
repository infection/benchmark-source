...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder16;
...
#[CoversClass(ResourceFinder16::class)]
final class ResourceFinder16Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder16(10);
    ...
    {
        $instance = new ResourceFinder16(10);
    ...
    {
        $finder = new ResourceFinder16($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder16(value=%s)', $i),
            ];
        }
    }
}
