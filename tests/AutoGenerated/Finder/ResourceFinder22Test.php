...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder22;
...
#[CoversClass(ResourceFinder22::class)]
final class ResourceFinder22Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder22(10);
    ...
    {
        $instance = new ResourceFinder22(10);
    ...
    {
        $finder = new ResourceFinder22($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder22(value=%s)', $i),
            ];
        }
    }
}
