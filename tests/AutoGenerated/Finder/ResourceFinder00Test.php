...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder00;
...
#[CoversClass(ResourceFinder00::class)]
final class ResourceFinder00Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder00(10);
    ...
    {
        $instance = new ResourceFinder00(10);
    ...
    {
        $finder = new ResourceFinder00($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder00(value=%s)', $i),
            ];
        }
    }
}
