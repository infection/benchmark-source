...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder29;
...
#[CoversClass(ResourceFinder29::class)]
final class ResourceFinder29Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder29(10);
    ...
    {
        $instance = new ResourceFinder29(10);
    ...
    {
        $finder = new ResourceFinder29($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder29(value=%s)', $i),
            ];
        }
    }
}
