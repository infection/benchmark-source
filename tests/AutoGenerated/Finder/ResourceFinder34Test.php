...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder34;
...
#[CoversClass(ResourceFinder34::class)]
final class ResourceFinder34Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder34(10);
    ...
    {
        $instance = new ResourceFinder34(10);
    ...
    {
        $finder = new ResourceFinder34($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder34(value=%s)', $i),
            ];
        }
    }
}
