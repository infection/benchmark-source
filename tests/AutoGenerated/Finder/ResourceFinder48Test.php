...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder48;
...
#[CoversClass(ResourceFinder48::class)]
final class ResourceFinder48Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder48(10);
    ...
    {
        $instance = new ResourceFinder48(10);
    ...
    {
        $finder = new ResourceFinder48($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder48(value=%s)', $i),
            ];
        }
    }
}
