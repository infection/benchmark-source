...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder36;
...
#[CoversClass(ResourceFinder36::class)]
final class ResourceFinder36Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder36(10);
    ...
    {
        $instance = new ResourceFinder36(10);
    ...
    {
        $finder = new ResourceFinder36($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder36(value=%s)', $i),
            ];
        }
    }
}
