...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder38;
...
#[CoversClass(ResourceFinder38::class)]
final class ResourceFinder38Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder38(10);
    ...
    {
        $instance = new ResourceFinder38(10);
    ...
    {
        $finder = new ResourceFinder38($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder38(value=%s)', $i),
            ];
        }
    }
}
