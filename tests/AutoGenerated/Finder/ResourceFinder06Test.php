...
use Infection\BenchmarkSource\AutoGenerated\Finder\ResourceFinder06;
...
#[CoversClass(ResourceFinder06::class)]
final class ResourceFinder06Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        new ResourceFinder06(10);
    ...
    {
        $instance = new ResourceFinder06(10);
    ...
    {
        $finder = new ResourceFinder06($value);
    ...
    public static function toStringProvider(): iterable
    {
        for ($i = 1; $i < 50; $i++) {
            yield [
                $i,
                sprintf('ResourceFinder06(value=%s)', $i),
            ];
        }
    }
}
