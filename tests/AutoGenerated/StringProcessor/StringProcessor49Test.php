...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor49;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor49::class)]
final class StringProcessor49Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor49('Hello World');
    ...
    {
        $processor = new StringProcessor49('Hello World', false);
    ...
    {
        $processor = new StringProcessor49('Hello');
    ...
    {
        $processor = new StringProcessor49($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor49($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor49($value);
