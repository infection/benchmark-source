...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor30;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor30::class)]
final class StringProcessor30Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor30('Hello World');
    ...
    {
        $processor = new StringProcessor30('Hello World', false);
    ...
    {
        $processor = new StringProcessor30('Hello');
    ...
    {
        $processor = new StringProcessor30($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor30($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor30($value);
