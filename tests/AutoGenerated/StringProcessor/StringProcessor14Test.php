...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor14;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor14::class)]
final class StringProcessor14Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor14('Hello World');
    ...
    {
        $processor = new StringProcessor14('Hello World', false);
    ...
    {
        $processor = new StringProcessor14('Hello');
    ...
    {
        $processor = new StringProcessor14($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor14($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor14($value);
