...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor16;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor16::class)]
final class StringProcessor16Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor16('Hello World');
    ...
    {
        $processor = new StringProcessor16('Hello World', false);
    ...
    {
        $processor = new StringProcessor16('Hello');
    ...
    {
        $processor = new StringProcessor16($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor16($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor16($value);
