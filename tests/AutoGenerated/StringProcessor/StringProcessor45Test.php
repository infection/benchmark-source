...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor45;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor45::class)]
final class StringProcessor45Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor45('Hello World');
    ...
    {
        $processor = new StringProcessor45('Hello World', false);
    ...
    {
        $processor = new StringProcessor45('Hello');
    ...
    {
        $processor = new StringProcessor45($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor45($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor45($value);
