...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor27;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor27::class)]
final class StringProcessor27Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor27('Hello World');
    ...
    {
        $processor = new StringProcessor27('Hello World', false);
    ...
    {
        $processor = new StringProcessor27('Hello');
    ...
    {
        $processor = new StringProcessor27($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor27($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor27($value);
