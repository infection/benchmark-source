...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor10;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor10::class)]
final class StringProcessor10Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor10('Hello World');
    ...
    {
        $processor = new StringProcessor10('Hello World', false);
    ...
    {
        $processor = new StringProcessor10('Hello');
    ...
    {
        $processor = new StringProcessor10($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor10($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor10($value);
