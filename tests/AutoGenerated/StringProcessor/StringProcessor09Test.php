...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor09;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor09::class)]
final class StringProcessor09Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor09('Hello World');
    ...
    {
        $processor = new StringProcessor09('Hello World', false);
    ...
    {
        $processor = new StringProcessor09('Hello');
    ...
    {
        $processor = new StringProcessor09($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor09($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor09($value);
