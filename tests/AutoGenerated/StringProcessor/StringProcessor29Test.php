...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor29;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor29::class)]
final class StringProcessor29Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor29('Hello World');
    ...
    {
        $processor = new StringProcessor29('Hello World', false);
    ...
    {
        $processor = new StringProcessor29('Hello');
    ...
    {
        $processor = new StringProcessor29($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor29($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor29($value);
