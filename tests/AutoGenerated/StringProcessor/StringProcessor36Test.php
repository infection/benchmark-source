...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor36;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor36::class)]
final class StringProcessor36Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor36('Hello World');
    ...
    {
        $processor = new StringProcessor36('Hello World', false);
    ...
    {
        $processor = new StringProcessor36('Hello');
    ...
    {
        $processor = new StringProcessor36($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor36($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor36($value);
