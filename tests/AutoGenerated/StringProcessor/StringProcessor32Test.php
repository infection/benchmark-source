...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor32;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor32::class)]
final class StringProcessor32Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor32('Hello World');
    ...
    {
        $processor = new StringProcessor32('Hello World', false);
    ...
    {
        $processor = new StringProcessor32('Hello');
    ...
    {
        $processor = new StringProcessor32($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor32($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor32($value);
