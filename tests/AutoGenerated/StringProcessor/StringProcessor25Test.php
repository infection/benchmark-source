...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor25;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor25::class)]
final class StringProcessor25Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor25('Hello World');
    ...
    {
        $processor = new StringProcessor25('Hello World', false);
    ...
    {
        $processor = new StringProcessor25('Hello');
    ...
    {
        $processor = new StringProcessor25($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor25($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor25($value);
