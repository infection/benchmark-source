...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor18;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor18::class)]
final class StringProcessor18Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor18('Hello World');
    ...
    {
        $processor = new StringProcessor18('Hello World', false);
    ...
    {
        $processor = new StringProcessor18('Hello');
    ...
    {
        $processor = new StringProcessor18($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor18($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor18($value);
