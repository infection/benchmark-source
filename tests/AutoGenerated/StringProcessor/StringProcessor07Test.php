...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor07;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor07::class)]
final class StringProcessor07Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor07('Hello World');
    ...
    {
        $processor = new StringProcessor07('Hello World', false);
    ...
    {
        $processor = new StringProcessor07('Hello');
    ...
    {
        $processor = new StringProcessor07($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor07($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor07($value);
