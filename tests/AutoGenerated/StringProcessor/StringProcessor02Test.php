...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor02;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor02::class)]
final class StringProcessor02Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor02('Hello World');
    ...
    {
        $processor = new StringProcessor02('Hello World', false);
    ...
    {
        $processor = new StringProcessor02('Hello');
    ...
    {
        $processor = new StringProcessor02($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor02($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor02($value);
