...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor17;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor17::class)]
final class StringProcessor17Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor17('Hello World');
    ...
    {
        $processor = new StringProcessor17('Hello World', false);
    ...
    {
        $processor = new StringProcessor17('Hello');
    ...
    {
        $processor = new StringProcessor17($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor17($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor17($value);
