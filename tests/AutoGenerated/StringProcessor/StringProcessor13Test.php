...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor13;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor13::class)]
final class StringProcessor13Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor13('Hello World');
    ...
    {
        $processor = new StringProcessor13('Hello World', false);
    ...
    {
        $processor = new StringProcessor13('Hello');
    ...
    {
        $processor = new StringProcessor13($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor13($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor13($value);
