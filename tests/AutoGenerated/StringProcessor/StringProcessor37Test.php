...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor37;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor37::class)]
final class StringProcessor37Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor37('Hello World');
    ...
    {
        $processor = new StringProcessor37('Hello World', false);
    ...
    {
        $processor = new StringProcessor37('Hello');
    ...
    {
        $processor = new StringProcessor37($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor37($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor37($value);
