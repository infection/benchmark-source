...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor33;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor33::class)]
final class StringProcessor33Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor33('Hello World');
    ...
    {
        $processor = new StringProcessor33('Hello World', false);
    ...
    {
        $processor = new StringProcessor33('Hello');
    ...
    {
        $processor = new StringProcessor33($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor33($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor33($value);
