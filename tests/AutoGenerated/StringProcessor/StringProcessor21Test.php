...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor21;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor21::class)]
final class StringProcessor21Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor21('Hello World');
    ...
    {
        $processor = new StringProcessor21('Hello World', false);
    ...
    {
        $processor = new StringProcessor21('Hello');
    ...
    {
        $processor = new StringProcessor21($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor21($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor21($value);
