...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor48;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor48::class)]
final class StringProcessor48Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor48('Hello World');
    ...
    {
        $processor = new StringProcessor48('Hello World', false);
    ...
    {
        $processor = new StringProcessor48('Hello');
    ...
    {
        $processor = new StringProcessor48($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor48($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor48($value);
