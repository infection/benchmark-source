...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor03;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor03::class)]
final class StringProcessor03Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor03('Hello World');
    ...
    {
        $processor = new StringProcessor03('Hello World', false);
    ...
    {
        $processor = new StringProcessor03('Hello');
    ...
    {
        $processor = new StringProcessor03($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor03($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor03($value);
