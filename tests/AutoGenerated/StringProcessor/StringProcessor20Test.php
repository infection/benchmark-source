...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor20;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor20::class)]
final class StringProcessor20Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor20('Hello World');
    ...
    {
        $processor = new StringProcessor20('Hello World', false);
    ...
    {
        $processor = new StringProcessor20('Hello');
    ...
    {
        $processor = new StringProcessor20($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor20($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor20($value);
