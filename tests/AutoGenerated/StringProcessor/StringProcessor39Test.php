...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor39;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor39::class)]
final class StringProcessor39Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor39('Hello World');
    ...
    {
        $processor = new StringProcessor39('Hello World', false);
    ...
    {
        $processor = new StringProcessor39('Hello');
    ...
    {
        $processor = new StringProcessor39($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor39($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor39($value);
