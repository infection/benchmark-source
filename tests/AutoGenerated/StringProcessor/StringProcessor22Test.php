...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor22;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor22::class)]
final class StringProcessor22Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor22('Hello World');
    ...
    {
        $processor = new StringProcessor22('Hello World', false);
    ...
    {
        $processor = new StringProcessor22('Hello');
    ...
    {
        $processor = new StringProcessor22($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor22($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor22($value);
