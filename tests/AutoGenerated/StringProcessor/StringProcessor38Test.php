...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor38;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor38::class)]
final class StringProcessor38Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor38('Hello World');
    ...
    {
        $processor = new StringProcessor38('Hello World', false);
    ...
    {
        $processor = new StringProcessor38('Hello');
    ...
    {
        $processor = new StringProcessor38($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor38($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor38($value);
