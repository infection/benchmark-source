...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor01;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor01::class)]
final class StringProcessor01Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor01('Hello World');
    ...
    {
        $processor = new StringProcessor01('Hello World', false);
    ...
    {
        $processor = new StringProcessor01('Hello');
    ...
    {
        $processor = new StringProcessor01($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor01($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor01($value);
