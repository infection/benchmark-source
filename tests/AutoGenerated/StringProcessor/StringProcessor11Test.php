...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor11;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor11::class)]
final class StringProcessor11Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor11('Hello World');
    ...
    {
        $processor = new StringProcessor11('Hello World', false);
    ...
    {
        $processor = new StringProcessor11('Hello');
    ...
    {
        $processor = new StringProcessor11($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor11($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor11($value);
