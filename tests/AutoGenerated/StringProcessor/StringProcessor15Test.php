...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor15;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor15::class)]
final class StringProcessor15Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor15('Hello World');
    ...
    {
        $processor = new StringProcessor15('Hello World', false);
    ...
    {
        $processor = new StringProcessor15('Hello');
    ...
    {
        $processor = new StringProcessor15($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor15($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor15($value);
