...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor08;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor08::class)]
final class StringProcessor08Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor08('Hello World');
    ...
    {
        $processor = new StringProcessor08('Hello World', false);
    ...
    {
        $processor = new StringProcessor08('Hello');
    ...
    {
        $processor = new StringProcessor08($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor08($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor08($value);
