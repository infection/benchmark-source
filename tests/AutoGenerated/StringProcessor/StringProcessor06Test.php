...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor06;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor06::class)]
final class StringProcessor06Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor06('Hello World');
    ...
    {
        $processor = new StringProcessor06('Hello World', false);
    ...
    {
        $processor = new StringProcessor06('Hello');
    ...
    {
        $processor = new StringProcessor06($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor06($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor06($value);
