...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor47;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor47::class)]
final class StringProcessor47Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor47('Hello World');
    ...
    {
        $processor = new StringProcessor47('Hello World', false);
    ...
    {
        $processor = new StringProcessor47('Hello');
    ...
    {
        $processor = new StringProcessor47($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor47($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor47($value);
