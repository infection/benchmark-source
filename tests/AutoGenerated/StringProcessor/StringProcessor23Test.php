...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor23;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor23::class)]
final class StringProcessor23Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor23('Hello World');
    ...
    {
        $processor = new StringProcessor23('Hello World', false);
    ...
    {
        $processor = new StringProcessor23('Hello');
    ...
    {
        $processor = new StringProcessor23($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor23($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor23($value);
