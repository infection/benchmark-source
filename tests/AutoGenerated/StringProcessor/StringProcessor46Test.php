...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor46;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor46::class)]
final class StringProcessor46Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor46('Hello World');
    ...
    {
        $processor = new StringProcessor46('Hello World', false);
    ...
    {
        $processor = new StringProcessor46('Hello');
    ...
    {
        $processor = new StringProcessor46($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor46($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor46($value);
