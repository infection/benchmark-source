...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor12;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor12::class)]
final class StringProcessor12Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor12('Hello World');
    ...
    {
        $processor = new StringProcessor12('Hello World', false);
    ...
    {
        $processor = new StringProcessor12('Hello');
    ...
    {
        $processor = new StringProcessor12($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor12($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor12($value);
