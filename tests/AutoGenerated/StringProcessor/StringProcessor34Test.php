...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor34;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor34::class)]
final class StringProcessor34Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor34('Hello World');
    ...
    {
        $processor = new StringProcessor34('Hello World', false);
    ...
    {
        $processor = new StringProcessor34('Hello');
    ...
    {
        $processor = new StringProcessor34($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor34($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor34($value);
