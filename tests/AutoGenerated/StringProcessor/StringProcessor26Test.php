...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor26;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor26::class)]
final class StringProcessor26Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor26('Hello World');
    ...
    {
        $processor = new StringProcessor26('Hello World', false);
    ...
    {
        $processor = new StringProcessor26('Hello');
    ...
    {
        $processor = new StringProcessor26($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor26($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor26($value);
