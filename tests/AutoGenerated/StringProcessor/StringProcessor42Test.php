...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor42;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor42::class)]
final class StringProcessor42Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor42('Hello World');
    ...
    {
        $processor = new StringProcessor42('Hello World', false);
    ...
    {
        $processor = new StringProcessor42('Hello');
    ...
    {
        $processor = new StringProcessor42($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor42($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor42($value);
