...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor28;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor28::class)]
final class StringProcessor28Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor28('Hello World');
    ...
    {
        $processor = new StringProcessor28('Hello World', false);
    ...
    {
        $processor = new StringProcessor28('Hello');
    ...
    {
        $processor = new StringProcessor28($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor28($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor28($value);
