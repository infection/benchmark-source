...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor40;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor40::class)]
final class StringProcessor40Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor40('Hello World');
    ...
    {
        $processor = new StringProcessor40('Hello World', false);
    ...
    {
        $processor = new StringProcessor40('Hello');
    ...
    {
        $processor = new StringProcessor40($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor40($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor40($value);
