...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor43;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor43::class)]
final class StringProcessor43Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor43('Hello World');
    ...
    {
        $processor = new StringProcessor43('Hello World', false);
    ...
    {
        $processor = new StringProcessor43('Hello');
    ...
    {
        $processor = new StringProcessor43($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor43($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor43($value);
