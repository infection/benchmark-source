...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor04;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor04::class)]
final class StringProcessor04Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor04('Hello World');
    ...
    {
        $processor = new StringProcessor04('Hello World', false);
    ...
    {
        $processor = new StringProcessor04('Hello');
    ...
    {
        $processor = new StringProcessor04($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor04($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor04($value);
