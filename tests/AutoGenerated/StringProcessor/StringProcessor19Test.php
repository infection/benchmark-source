...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor19;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor19::class)]
final class StringProcessor19Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor19('Hello World');
    ...
    {
        $processor = new StringProcessor19('Hello World', false);
    ...
    {
        $processor = new StringProcessor19('Hello');
    ...
    {
        $processor = new StringProcessor19($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor19($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor19($value);
