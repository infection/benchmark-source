...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor44;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor44::class)]
final class StringProcessor44Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor44('Hello World');
    ...
    {
        $processor = new StringProcessor44('Hello World', false);
    ...
    {
        $processor = new StringProcessor44('Hello');
    ...
    {
        $processor = new StringProcessor44($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor44($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor44($value);
