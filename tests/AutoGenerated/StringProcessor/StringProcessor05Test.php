...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor05;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor05::class)]
final class StringProcessor05Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor05('Hello World');
    ...
    {
        $processor = new StringProcessor05('Hello World', false);
    ...
    {
        $processor = new StringProcessor05('Hello');
    ...
    {
        $processor = new StringProcessor05($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor05($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor05($value);
