...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor31;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor31::class)]
final class StringProcessor31Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor31('Hello World');
    ...
    {
        $processor = new StringProcessor31('Hello World', false);
    ...
    {
        $processor = new StringProcessor31('Hello');
    ...
    {
        $processor = new StringProcessor31($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor31($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor31($value);
