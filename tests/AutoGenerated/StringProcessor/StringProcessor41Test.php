...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor41;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor41::class)]
final class StringProcessor41Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor41('Hello World');
    ...
    {
        $processor = new StringProcessor41('Hello World', false);
    ...
    {
        $processor = new StringProcessor41('Hello');
    ...
    {
        $processor = new StringProcessor41($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor41($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor41($value);
