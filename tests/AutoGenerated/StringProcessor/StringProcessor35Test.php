...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor35;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor35::class)]
final class StringProcessor35Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor35('Hello World');
    ...
    {
        $processor = new StringProcessor35('Hello World', false);
    ...
    {
        $processor = new StringProcessor35('Hello');
    ...
    {
        $processor = new StringProcessor35($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor35($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor35($value);
