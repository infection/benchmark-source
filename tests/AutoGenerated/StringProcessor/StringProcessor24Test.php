...
use Infection\BenchmarkSource\AutoGenerated\StringProcessor\StringProcessor24;
use InvalidArgumentException;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;

#[CoversClass(StringProcessor24::class)]
final class StringProcessor24Test extends TestCase
{
    public function test_can_be_instantiated(): void
    {
        $processor = new StringProcessor24('Hello World');
    ...
    {
        $processor = new StringProcessor24('Hello World', false);
    ...
    {
        $processor = new StringProcessor24('Hello');
    ...
    {
        $processor = new StringProcessor24($haystack, $caseSensitive);
    ...
    {
        $processor = new StringProcessor24($value, $caseSensitive);
    ...
    {
        $processor = new StringProcessor24($value);
